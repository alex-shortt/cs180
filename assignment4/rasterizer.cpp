        ...
        for(int y = (int) miny - 1.; y < (int) maxy + 1.; y++) {
            ...
            if(insideTriangle(x, y, &v[0])) {
                ...
                if(-zp < depth_buf[index]){
                    ...
                    fragment_shader_payload frag_payload(interpolated_color, interpolated_normal.normalized(), interpolated_texcoords, texture ? &*texture : nullptr);
                    frag_payload.view_pos = interpolated_shadingcoords;
                    auto output_color = fragment_shader(frag_payload);
                    
                    frame_buf[index] = output_color;
                }
            }
        }
    }
